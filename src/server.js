...
// Mount Redis demo router
const redisDemoRouter = require("./routers/redisDemo.routes");
app.use("/demo", redisDemoRouter);
...
// Khởi động server với Redis
async function startServer() {
  try {
    // Kết nối Redis trước khi start server
    await connectRedis();
